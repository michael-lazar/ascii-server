...
class AdvancedSearchForm(forms.Form):
    def __init__(self, artfiles: ArtFileQuerySet, *args, **kwargs):
        ...
        self.fields["order"] = forms.ChoiceField(
            choices=(
                ("", ""),
                ("pack__year", "year (oldest to newest)"),
                ("-pack__year", "year (newest to oldest)"),
                ("name", "name (A-Z)"),
                ("-name", "name (Z-A)"),
                ("filesize", "size (small to large)"),
                ("-filesize", "size (large to small)"),
                ("number_of_lines", "rows (short to tall)"),
                ("-number_of_lines", "rows (tall to short)"),
                ("character_width", "columns (narrow to wide)"),
                ("-character_width", "columns (wide to narrow)"),
            ),
            label="Sort Order",
